...
function smarty($data_count,$queryset){
	...
	if((strpos($ua,'Android') !== false) && (strpos($ua,'Mobile') !== false) || (strpos($ua,'iPhone') !== false ) || (strpos($ua,'Windows Phone') !== false)){
		//スマートフォンからアクセスされた場合
		$samrty->assign('user_agent','smartphone');
		exit();
	}elseif((strpos($ua,'DoCoMo') !== false) || (strpos($ua,'KDDI') !== false) || (strpos($ua,'SoftBank') !== false)|| (strpos($ua,'vodafone') !== false) || (strpos($ua,'J-PHONE') !== false)){
		//携帯からアクセスしてきた場合
		$samrty->assign('user_agent','mobile');
		exit();
	}else{
		//その他（タブレットやPCからアクセスしていた場合
		$samrty->assign('user_agent','PC');
		exit();
	}
	$smarty->template_dir = '/home/co-67.3919.com/public_html/kadai4/Smarty_design/smarty/templates/';
	$smarty->compile_dir  = '/home/co-67.3919.com/public_html/kadai4/Smarty_design/smarty/templates_c/';
	$smarty->config_dir   = '/home/co-67.3919.com/public_html/kadai4/Smarty_design/smarty/config/';
	$smarty->cache_dir    = '/home/co-67.3919.com/public_html/kadai4/Smarty_design/smarty/cache/';
