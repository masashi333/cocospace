...
function smarty($data_count,$queryset){
	...
	$smarty->template_dir = '/home/co-67.3919.com/public_html/kadai4/Smarty_design/user_agent/templates/';
	$smarty->compile_dir  = '/home/co-67.3919.com/public_html/kadai4/Smarty_design/user_agent/templates_c/';
	$smarty->config_dir   = '/home/co-67.3919.com/public_html/kadai4/Smarty_design/user_agent/config/';
	$smarty->cache_dir    = '/home/co-67.3919.com/public_html/kadai4/Smarty_design/user_agent/cache/';

	//文字をテンプレートに渡す
	$smarty->assign('data_count',$data_count);
	$smarty->assign('queryset',$queryset);
	$smarty->display('user_agent.tpl');
